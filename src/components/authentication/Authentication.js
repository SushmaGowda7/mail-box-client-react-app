...
const Authentication = (props) => {
    ...
    const loginHandler = (email, password) => {
        fetch(
            'https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyCT9D8qYGXLctLHTFpHLy2GVQo57PeC9GY',
            {
                    method: 'POST',
                    body: JSON.stringify({
                        email: email,
    ...
    const forgotPasswordHandler = (email) => {
        fetch(
            'https://identitytoolkit.googleapis.com/v1/accounts:sendOobCode?key=AIzaSyCT9D8qYGXLctLHTFpHLy2GVQo57PeC9GY',
            {
                method: 'POST',
                body: JSON.stringify({
                    email: email,
